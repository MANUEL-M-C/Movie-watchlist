...
# SECURITY: Use environment variable with fallback for local dev
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-3umg8805tm*_g^plq3okt-9)ouxb4%wjrlw-nm!fristi8g@sm')
